...
public class BParkClientScenes {
	...
	public static void showLoginScreen(Stage stage) throws Exception {
		...
		BParkLauncherApp.setStageIcon(stage);
...
//			}
			...
			// Set the application icon
			BParkLauncherApp.setStageIcon(currentStage);
...
//			connectToServer();
	...
	public static void showParkingHistoryWindow(ArrayList<ParkingOrder> history) {
		try {
			...
			// Set the application icon for the history window
			BParkLauncherApp.setStageIcon(historyStage);
